...
if save:
    ...
    fig, ax = plt.subplots()
    ax.errorbar(time, mean_D_list, yerr=std_D_list, capsize=10)
    ...
    fig, ax = plt.subplots()
    ax.errorbar(time, mean_arrested_list, yerr=std_arrested_list, label='Total number of arrested agents', capsize=10)
    ax.errorbar(time, mean_type_1_arrested_list, yerr=std_type_1_arrested_list, label='Total number of type 1 arrested agents', capsize=10)
    ax.errorbar(time, mean_type_0_arrested_list,yerr=std_type_0_arrested_list, label='Total number of type 0 arrested agents', capsize=10)
    ...
    fig, ax = plt.subplots()
    ax.errorbar(time, mean_active_list, yerr=std_active_list, label='Total number of active agents', capsize=10)
    ax.errorbar(time, mean_type_1_active_list, yerr=std_type_1_active_list, label='Total number of type 1 active agents', capsize=10)
    ax.errorbar(time, mean_type_0_active_list, yerr=std_type_0_active_list, label='Total number of type 0 active agents', capsize=10)
